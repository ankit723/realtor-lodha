...
const LifeAtCrown = () => {
  return (
    <div className="information-section mb-20 mt-24 px-4 md:px-10" style={{ marginTop: "2rem" }}>
      <div className="section mb-12">
        <div className="flex md:flex-row flex-col justify-between items-center gap-5">
          <div className="image-title-wrapper flex justify-center md:justify-start">
            <div className="section-image flex justify-center items-center">
              <svg enable-background="new 0 0 32.467 35" height="35px" version="1.1" viewBox="0 0 32.467 35" width="32.467px" x="0px" xmlns="http://www.w3.org/2000/svg" y="0px"><g><path d="M32.413,15.062c0.021-0.038,0.035-0.079,0.047-0.12v-0.043c0.01-0.054,0.01-0.11,0-0.163l0,0
                                   ...
                                   c0.191,0,0.367-0.113,0.439-0.292l1.106-2.668h6.313L17.93,31.621z"></path><path d="M16.201,4.927c0.264,0,0.48-0.215,0.48-0.479V0.479c0-0.265-0.215-0.479-0.48-0.479s-0.479,0.214-0.479,0.479v3.967
                                   C15.722,4.71,15.936,4.927,16.201,4.927z"></path><path d="M21.141,5.419c0.125,0,0.247-0.051,0.336-0.14l2.81-2.808c0.186-0.187,0.186-0.488,0-0.675
                                   c-0.188-0.188-0.49-0.19-0.679-0.004c-0.001,0.002-0.002,0.003-0.003,0.004L20.802,4.6c-0.188,0.186-0.189,0.489-0.004,0.677
                                   C20.888,5.369,21.013,5.419,21.141,5.419L21.141,5.419z"></path><path d="M10.93,5.279c0.188,0.187,0.49,0.185,0.677-0.002c0.187-0.188,0.186-0.49-0.002-0.678l0,0L8.798,1.797
                                   C8.612,1.608,8.31,1.608,8.121,1.794c-0.001,0-0.002,0.002-0.003,0.003c-0.185,0.187-0.185,0.487,0,0.676L10.93,5.279z"></path></g></svg>
            </div>
            <h1 className="text-2xl font-bold text-left">
              <span className="text-black">LIFE AT</span> <br /> CROWN TALOJA
            </h1>
          </div>
          <div className="info-cell flex-1">
      ...
      <div className="w-full flex justify-center">
        <img
          src="https://s3.ap-south-1.amazonaws.com/lodhagroup.in-tfz/Codename-Goldendream/1000x400_life_at_01.jpg"
          className="Goldendream-project-image w-full h-auto object-cover"
          alt="Life at Crown Taloja"
        />
      </div>
    </div>
  );
