...
const About = () => {
  return (
    <div className="container my-10" style={{marginTop:'5rem', marginBottom:"5rem"}}>
      {/* ABOUT Section */}

      <div className="w-full grid grid-cols-2 items-start">
        <div className="image-title-wrapper">
          <img src="https://www.lodhagroup.in/themes/basic/images/svg/5-bar-black.svg" width="60px" height="60px" alt="About" className="section-image" />
          <h1 className='font-bold text-2xl text-left'> <span className='text-black'>ABOUT</span> <br /> LODHA</h1>
        </div>
      ...
      <div className="w-full grid grid-cols-2 items-start my-20">
        <div className="image-title-wrapper">
          <img src="https://www.lodhagroup.in/themes/basic/images/svg/5-bar-black.svg" width="60px" height="60px" alt="About" className="section-image" />
          <h1 className='font-bold text-2xl text-left'> <span className='text-black'>Special</span> <br /> Offer</h1>
        </div>

        <div className="text-left font-bold flex flex-col gap-8">
          <p className='text-md'>No pre-emi for 12 months and additional festive offers</p>
        </div>
      </div>
      ...
      <div className="w-full grid grid-cols-2 items-start">
        <div className="image-title-wrapper">
          <img src="https://www.lodhagroup.in/themes/basic/images/svg/5-bar-black.svg" width="60px" height="60px" alt="About" className="section-image" />
          <h1 className='font-bold text-left text-2xl'> <span className='text-black'>CROWN TALOJA BY LODHA</span> <br /> JIYO TOH AISE</h1>
        </div>
