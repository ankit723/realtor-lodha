    ...
    return (
        <div>
            <div className="plans-container">
                <div className="plans-title">
                    <div className="image-title-wrapper">
                        <div className="section-image flex justify-center items-center">
                            <svg enable-background="new 410.607 282.64 20.675 30" height="30px" version="1.1" viewBox="410.607 282.64 20.675 30" width="20.675px" x="0px" xmlns="http://www.w3.org/2000/svg" y="0px"> <path d="M430.109,289.611c-0.914,0-1.826,0-2.74,0c-0.404,0-0.809,0-1.213,0c-0.112-0.867-0.346-1.671-0.714-2.473
              ...
              c0.012,0,0.021,0,0.033,0c0.639,0,1.174-0.534,1.174-1.174C431.282,290.145,430.747,289.611,430.109,289.611z"></path> </svg>
                        </div>
